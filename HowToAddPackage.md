...
- fill the Https link for the package, in this case, 'https://github.com/tglGames-Plugins/tgl-event-bus'
- Add
The package will be added under 'TGL Event Bus' in packages, use as needed.
...
so, if the project is at: `/home/thegamelearner/Documents/Unity Projects/All_Plugins`
the toml file is at: `/home/thegamelearner/Documents/Unity Projects/All_Plugins/Assets/AccessConfig/upmconfig.toml`
and the unity we are using is at: `/home/thegamelearner/Unity/Hub/Editor/6000.2.6f2/Editor/unityhub-unity-editor-6000.2.6f2`

we will open Unity as :
```sh
$ export UPM_USER_CONFIG_FILE="/home/thegamelearner/Documents/Unity Projects/All_Plugins/Assets/AccessConfig/upmconfig.toml"
$
$ "/home/thegamelearner/Unity/Hub/Editor/6000.2.6f2/Editor/unityhub-unity-editor-6000.2.6f2" -projectPath "/home/thegamelearner/Documents/Unity Projects/All_Plugins"
```
...
- add the name and version
	- name: `com.tglgames.tgl-event-bus`
